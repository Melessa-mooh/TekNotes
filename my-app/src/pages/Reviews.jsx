        ...
        <header className="header">
          {/* Title & Description moved INSIDE Header Left */}
            <div className="page-header-text" style={{ marginLeft: "15px" }}>
               <h1 style={{ fontSize: "24px", fontWeight: "700", margin: 0, color: "#1e293b" }}>Reviews</h1>
               <p style={{ margin: 0, color: "#64748b", fontSize: "14px" }}>Evaluate learning materials and identify quality resources</p>
            </div>
